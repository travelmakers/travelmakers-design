...
var BackIcon = require('./BackIcon.js');
var HeaderSection_style = require('./HeaderSection.style.js');
...
const HeaderSection = React.forwardRef((_a, ref) => {
  var _b = _a, { size = "small", title, className, co, overrideStyles } = _b, props = __objRest(_b, ["size", "title", "className", "co", "overrideStyles"]);
  styles.useTmTheme();
  const { classes, cx } = HeaderSection_style["default"]({ size }, { overrideStyles, name: "HeaderSection" });
  ...
  }, /* @__PURE__ */ React__default.createElement(BackIcon.BackIcon, {
