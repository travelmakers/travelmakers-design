...
import useStyles from './OptionCard.style.js';
...
const OptionCard = forwardRef((_a, ref) => {
  ...
  const { classes, cx } = useStyles({}, { overrideStyles, name: "OptionCard" });
  return /* @__PURE__ */ React.createElement(View, __spreadValues({
    ...
    strong: true
  }, optionName), isDuration && /* @__PURE__ */ React.createElement(Typography, {
    family: "Pretendard",
    level: "b2",
    color: theme.colors.navy1
  }, "(", minNight, "\uBC15 - ", maxNight, "\uBC15)")), /* @__PURE__ */ React.createElement(Typography, {
    family: "Pretendard",
    level: "b2",
    color: theme.colors.navy1,
    strong: true
    ...
    style: { height: "40px" }
  }, roomType), /* @__PURE__ */ React.createElement("div", {
  ...
  }, "\uB354\uBCF4\uAE30"), /* @__PURE__ */ React.createElement(Image, {
    src: require("../../assets/svg/ic-angle.svg"),
    className: cx(classes.arrowImage)
  }))), isPrice && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
    className: cx(classes.divider)
  }), /* @__PURE__ */ React.createElement(Typography, {
    family: "Pretendard",
    level: "b2",
  ...
  }, "\uC815\uAC00"), /* @__PURE__ */ React.createElement(Typography, {
    family: "Pretendard",
    level: "b3",
  ...
  }, new Intl.NumberFormat("ko-KR").format(price), "\uC6D0"))), /* @__PURE__ */ React.createElement("div", {
    className: cx(classes.flex, classes.spaceBetween)
  }, /* @__PURE__ */ React.createElement(Typography, {
    family: "Pretendard",
    level: "h6",
    ...
    strong: true
  }, salePercent, "%"), /* @__PURE__ */ React.createElement("div", {
    className: cx(classes.flex)
  }, /* @__PURE__ */ React.createElement(Typography, {
    family: "Pretendard",
    level: "h4",
    ...
    strong: true
  }, new Intl.NumberFormat("ko-KR").format(salePrice)), /* @__PURE__ */ React.createElement(Typography, {
    family: "Pretendard",
    level: "b2",
    color: theme.colors.navy1,
    style: {
