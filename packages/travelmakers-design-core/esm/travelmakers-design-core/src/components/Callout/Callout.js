...
import useStyles from './Callout.style.js';
import { CalloutAlertIcon } from './CalloutAlertIcon.js';
...
const Callout = forwardRef((_a, ref) => {
  var _b = _a, {
    type = "default",
    title,
    content,
  ...
  const { classes, cx } = useStyles({ type }, { overrideStyles, name: "Callout" });
  ...
  }, /* @__PURE__ */ React.createElement(CalloutAlertIcon, {
