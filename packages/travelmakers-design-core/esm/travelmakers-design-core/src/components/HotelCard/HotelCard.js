...
import useStyles from './HotelCard.style.js';
...
const HotelCard = forwardRef((_a, ref) => {
  var _b = _a, {
    type = "default",
    hotelImage,
    hotelItems = [],
  ...
  const { classes, cx } = useStyles({}, { overrideStyles, name: "HotelCard" });
  const SaleTextBox = () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
