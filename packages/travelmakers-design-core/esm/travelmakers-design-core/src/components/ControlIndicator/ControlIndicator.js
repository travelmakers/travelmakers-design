...
import useStyles from './ControlIndicator.style.js';
...
let SELECTED_PAGE = 1;
const ControlIndicator = forwardRef((_a, ref) => {
  var _b = _a, {
    color = "navy",
    size = "small",
    totalPage = 1,
  ...
  useTmTheme();
  const { classes, cx } = useStyles({ size }, { overrideStyles, name: "ControlIndicator" });
  ...
  return /* @__PURE__ */ React.createElement(View, __spreadValues({
    ...
    co
  }, props), /* @__PURE__ */ React.createElement(Progress, {
    color,
    size,
    totalPage,
