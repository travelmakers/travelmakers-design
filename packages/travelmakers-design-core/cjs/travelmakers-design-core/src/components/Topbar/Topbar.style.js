...
var useStyles = styles.createStyles((theme, { mobileType = "Expanded" }) => {
  return {
    root: {
    ...
    searchBox: {
      ...
      [`${theme.media.mobile}`]: {
        backgroundColor: mobileType === "Collapsed" ? "inherit" : theme.colors.gray6,
...
//# sourceMappingURL=Topbar.style.js.map
