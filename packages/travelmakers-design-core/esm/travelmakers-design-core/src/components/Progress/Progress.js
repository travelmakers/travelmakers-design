...
import useStyles from './Progress.style.js';
...
const Progress = forwardRef((_a, ref) => {
  ...
  useTmTheme();
  const { classes, cx } = useStyles({ color, indicator, size }, { overrideStyles, name: "Progress" });
  return /* @__PURE__ */ React.createElement(View, __spreadValues({
    ref,
    className: cx(classes.root, className),
    co
  }, props), indicator && /* @__PURE__ */ React.createElement(Indicator, {
    currentPage,
    totalPage,
    color,
    size,
