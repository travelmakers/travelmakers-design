...
var Image_style = require('./Image.style.js');
...
const Image = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = Image_style["default"]({ radius }, { overrideStyles, name: "Image" });
  ...
  }), (!loaded || lazy && !intersected) && placeholder && /* @__PURE__ */ React__default.createElement("div", {
