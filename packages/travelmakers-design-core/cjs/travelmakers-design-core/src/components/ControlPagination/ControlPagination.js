...
var ControlPagination_style = require('./ControlPagination.style.js');
...
let SELECTED_PAGE = 1;
const ControlPagination = React.forwardRef((_a, ref) => {
  var _b = _a, {
    color = "navy",
    size = "small",
    totalPage = 1,
  ...
  styles.useTmTheme();
  const { classes, cx } = ControlPagination_style["default"]({ color, size }, { overrideStyles, name: "ControlPagination" });
  ...
  return /* @__PURE__ */ React__default.createElement(View.View, __spreadValues({
    ...
    co
  }, props), /* @__PURE__ */ React__default.createElement(Image.Image, {
    src: previousButton,
    className: cx(classes.button),
    onClick: handlePreviousClick
  }), /* @__PURE__ */ React__default.createElement("span", {
    className: cx(classes.indicator)
  }, selectedPage, " / ", totalPage), /* @__PURE__ */ React__default.createElement(Image.Image, {
    src: nextButton,
    className: cx(classes.button),
