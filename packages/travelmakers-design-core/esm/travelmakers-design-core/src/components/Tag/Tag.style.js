...
var useStyles = createStyles((theme, { color, roundness, size, fill, disabled = false }) => {
  return {
    container: __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, defaultFontStyles(theme)), getFontStyles(theme)[size]), getPaddingStyles(theme, fill)[size]), {
      display: "flex",
