import { CoBreakpoints, CoOpacity, CoRadius, CoShadows, CoSpacing, CoZIndex, TmColor, TmFontSizes, TmMedia, TmPalette } from "../tokens";
...
export declare type TmThemeBase = Omit<TmTheme, "fn">;
export declare type TmThemeOverride = DeepPartial<Omit<TmTheme, "extra">> & {
    extra?: Record<string, any>;
};
export {};
//# sourceMappingURL=TmTheme.d.ts.map