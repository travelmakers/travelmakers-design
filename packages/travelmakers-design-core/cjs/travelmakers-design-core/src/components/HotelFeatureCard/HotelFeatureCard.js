...
var HotelFeatureCard_style = require('./HotelFeatureCard.style.js');
...
const HotelFeatureCard = React.forwardRef((_a, ref) => {
  var _b = _a, {
    type = "default",
    hotelImage,
    hotelItems = [],
  ...
  const { classes, cx } = HotelFeatureCard_style["default"]({}, { overrideStyles, name: "HotelFeatureCard" });
  const SaleTextBox = ({ children }) => /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("div", {
  ...
  }, "timer"), /* @__PURE__ */ React__default.createElement("div", {
...
exports.HotelFeatureCard = HotelFeatureCard;
