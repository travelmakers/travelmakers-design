...
var useStyles = styles.createStyles((theme, { multiline, roundness, invalid, width, descriptionType }) => {
  const invalidColor = theme.colors.red2;
  return {
    wrapper: {
      position: "relative"
    },
    input: __spreadProps(__spreadValues({}, styles.defaultFontStyles(theme)), {
