...
var useStyles = styles.createStyles((theme, { fill }) => {
  return {
    container: __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, styles.defaultFontStyles(theme)), getFontStyles(theme)["small"]), getPaddingStyles()["small"]), {
      display: "flex",
