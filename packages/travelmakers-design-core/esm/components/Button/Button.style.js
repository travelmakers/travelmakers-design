...
var useStyles = createStyles((theme, { variant: _variant, size, fullWidth, roundness, line }, getRef) => {
  ...
  return {
    ...
    ghost: {
      ...
      [`&:disabled:not(.${loading})`]: {
        ...
        border: `1px solid ${addAlpha(theme.palettes[variant][1], theme.opacity.opacity3)}`
      }
    },
    root: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, sizes[size]), getWidthStyles(fullWidth)), defaultFontStyles(theme)), getFontStyles(theme)[size]), {
