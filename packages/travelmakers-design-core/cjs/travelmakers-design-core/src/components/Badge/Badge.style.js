...
var useStyles = styles.createStyles((theme, { size, type }) => {
  return {
    container: __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, styles.defaultFontStyles(theme)), getFontStyles(theme, type)[size]), getPaddingStyles(theme, type)[size]), {
      display: "flex",
