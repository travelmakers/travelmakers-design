...
var Callout_style = require('./Callout.style.js');
var CalloutAlertIcon = require('./CalloutAlertIcon.js');
...
const Callout = React.forwardRef((_a, ref) => {
  var _b = _a, {
    type = "default",
    title,
    content,
  ...
  const { classes, cx } = Callout_style["default"]({ type }, { overrideStyles, name: "Callout" });
  ...
  }, /* @__PURE__ */ React__default.createElement(CalloutAlertIcon.CalloutAlertIcon, {
